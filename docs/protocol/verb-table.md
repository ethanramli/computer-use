...
desktop click --app NAME --x 640 --y 420
desktop click_type --app NAME --x 640 --y 420 "hello"
...
desktop type --app NAME "hello"
desktop press --app NAME enter
desktop hotkey --app NAME cmd,s
